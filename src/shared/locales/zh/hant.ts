...
export default {
    ...
    sv: {
        ...
        network: {
            registry: 'npm 鏡像源',
            registryHint: '版本清單、核心安裝與更新所用的網路源。',
            proxy: '代理',
            enable: '啟用代理',
            protocol: '通訊協定',
            protocolHttp: 'HTTP',
        ...
        dsh: {
            ...
            stopped: '已停止',
            kernelUpdate: '核心更新',
            checkOnStart: '啟動時檢查核心更新',
            checkOnStartDesc: '啟動時自動檢查核心更新。',
            checkPrerelease: '檢查測試版',
            checkPrereleaseDesc: '把 rc / beta 預先發行也當作候選。',
            checkUpdateTitle: '檢查 / 更新核心',
            checkUpdateDesc: '檢查並升級核心 {pkg}。',
            check: '檢查',
            update: '更新核心',
            versionMgmt: '版本管理',
            registry: 'npm 鏡像源',
            registryHint: '版本清單與安裝所用的網路源。',
